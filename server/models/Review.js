...
const reviewSchema = new mongoose.Schema({
  ...
  sentimentScore: { type: Number, default: null }, // 0.0 to 1.0 (or -1.0 to 1.0 depending on logic, let's say 0 to 100 for simplicity later, or just simple text 'Positive')
